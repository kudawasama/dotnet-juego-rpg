...
namespace MiJuegoRPG.PjDatos
{
    ...
    [JsonPropertyName("ciudadPrincipal")] public bool CiudadPrincipal { get; set; } = false;
    [JsonPropertyName("esCentroCiudad")] public bool EsCentroCiudad { get; set; } = false;
    [JsonPropertyName("parteCiudad")] public string? ParteCiudad { get; set; } = null;
