...
namespace MiJuegoRPG.PjDatos
{
    ...
    public class ArmaData
    {
        ...
        public int? DañoMin { get; set; }
        public int? DañoMax { get; set; }
        public int? DañoFisico { get; set; }
        public int? DañoMagico { get; set; }
        public Dictionary<string, int>? DañoElemental { get; set; }

        // Crítico y atributos de combate
        public double? CriticoProbabilidad { get; set; }
        public double? CriticoMultiplicador { get; set; }
        public double? Penetracion { get; set; }
        public double? Precision { get; set; }
        public double? VelocidadAtaque { get; set; }

        // Bonificadores y stats
        public Dictionary<string, int>? BonificadoresAtributos { get; set; }
        public Dictionary<string, int>? BonificadoresEstadisticas { get; set; }
        ...
        public Dictionary<string, int>? Requisitos { get; set; } // p.ej. {"Fuerza":5, "Nivel":2}
    ...
    // Modelos auxiliares opcionales (uso libre por el generador)
    public class EfectoData
    {
        public string? Tipo { get; set; } // OnHit | Aura | Uso
    ...
    public class HabilidadOtorgadaData
    {
