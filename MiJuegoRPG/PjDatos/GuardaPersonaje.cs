// Guardar el personaje creado, almacenar características del personaje con su avance y poder cargar personaje guardado
...
namespace MiJuegoRPG.PjDatos
{
    public class GuardaPersonaje
    {
        ...
        // SA1402: DatosGuardado se movió a DatosGuardado.cs para cumplir con SA1402 (un tipo por archivo)

        // Guardar personaje (lo agrega a la lista existente)
        // MÉTODO OBSOLETO: Guardar personaje en archivo JSON (NO USAR, migrado a SQLite)
        ...
        // MÉTODO OBSOLETO: Cargar todos los personajes desde archivos JSON (NO USAR, migrado a SQLite)
        ...
        // MÉTODO OBSOLETO: Cargar personaje específico por nombre desde archivos JSON (NO USAR, migrado a SQLite)
        ...
        // MÉTODO OBSOLETO: Mostrar lista de personajes guardados desde archivos JSON (NO USAR, migrado a SQLite)
        ...
        // Eliminar personaje
        // MÉTODO OBSOLETO: Eliminar personaje desde archivo JSON (NO USAR, migrado a SQLite)
