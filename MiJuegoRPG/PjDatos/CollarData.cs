...
namespace MiJuegoRPG.PjDatos
{
    public class CollarData
    {
        ...
        public int? BonificacionDefensaMin { get; set; }
        public int? BonificacionDefensaMax { get; set; }
        public int? BonificacionEnergiaMin { get; set; }
        public int? BonificacionEnergiaMax { get; set; }
