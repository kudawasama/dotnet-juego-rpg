namespace MiJuegoRPG.Personaje
{
    public class Estadisticas
    {
        ...
        {
            get; set;
        } // Probabilidad de evadir un ataque
        public double Velocidad
        {
            get; set;
        } // Velocidad de movimiento y ataque
        public double Ataque
        {
            get; set;
        } // Daño físico infligido
        public double Regeneracion
        {
            get; set;
        } // Regeneración de salud y recursos
        public double Resistencia
        {
            get; set;
        } // Resistencia a efectos negativos
        public double Salud
        {
            get; set;
        } // Salud máxima
        ...
        {
            get; set;
        } // Precisión para calcular acierto (0..1)
        public double CritChance
        {
            get; set;
        } // Probabilidad de crítico (alias moderno de Critico)
        public double CritMult
        {
            get; set;
        } // Multiplicador de crítico (>=1.0)
        public double Penetracion
        {
            get; set;
        } // Porcentaje de penetración de defensa (0..1)
        public double Daño
        {
            get; set;
        } // Daño físico infligido
        ...
        public double PoderOfensivoFisico
        {
            get; set;
        } // Potencia de habilidades físicas ofensivas
        public double PoderDefensivoFisico
        {
            get; set;
        } // Potencia de habilidades físicas defensivas
        ...
        {
            get; set;
        } // Reducción de daño mágico recibido
        public double RegeneracionMana
        {
            get; set;
        } // Regeneración de mana
        public double PoderDefensivoMagico
        {
            get; set;
        } // Defensa contra hechizos
        public double PoderOfensivoMagico
        {
            get; set;
        } // Potencia de hechizos ofensivos
        public double PoderEspiritual
        {
            get; set;
        } // Potencia de habilidades espirituales
        public double ResistenciaMagica
        {
            get; set;
        } // Resistencia a efectos mágicos
        public double AfinidadElemental
        {
            get; set;
        } // Conexión con elementos
        public double PoderElemental
        {
            get; set;
        } // Potencia de habilidades elementales
        public double ResistenciaElemental
        {
            get; set;
        } // Resistencia a efectos elementales
        public double PoderCurativo
        {
            get; set;
        } // Potencia de habilidades curativas
        public double PoderDeControl
        {
            get; set;
        } // Potencia de habilidades de control
        public double PoderDeSoporte
        {
            get; set;
        } // Potencia de habilidades de soporte
        public double PoderDeInvocacion
        {
            get; set;
        } // Potencia de habilidades de invocación
        public double PoderDeTransmutacion
        {
            get; set;
        } // Potencia de habilidades de transmutación
        public double PoderDeAlteracion
        {
            get; set;
        } // Potencia de habilidades de alteración
        public double PoderDeIlusion
        {
            get; set;
        } // Potencia de habilidades de ilusión
        public double PoderDeConjuracion
        {
            get; set;
        } // Potencia de habilidades de conjuración
        public double PoderDeDestruccion
        {
            get; set;
        } // Potencia de habilidades de destrucción
        public double PoderDeRestauracion
        {
            get; set;
        } // Potencia de habilidades de restauración
        public double PoderDeTransporte
        {
            get; set;
        } // Potencia de habilidades de transporte 
        public double PoderDeManipulacion
        {
            get; set;
        } // Potencia de habilidades de manipulación
