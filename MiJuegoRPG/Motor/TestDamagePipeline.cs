...
namespace MiJuegoRPG.Motor
{
    ...
    public static class TestDamagePipeline
    {
        public static void Probar()
        {
            ...
            var reqNoCrit = reqCrit; reqNoCrit.CritChance = 0; reqNoCrit.ForzarCritico = false;
            ...
            var reqEvade = reqCrit; reqEvade.EvasionObjetivo = 0.99; reqEvade.ForzarImpacto = false; reqEvade.ForzarCritico = false; reqEvade.CritChance = 0;
